...
public class CrosswordTile extends AbstractTile{
     ...
     */
    public CrosswordTile(String word){
       super(word);
    }
    /**
     ...
     */
    public CrosswordTile(String word, Color c, int x, int y, int size){
       super(word, c, x, y, size);
       rowPrompt = "";
       colPrompt = "";
       clueNumV = 0;
       clueNumH = 0;
     ...
     */
    public CrosswordTile(String word, Color c, int x, int y, int size, String rP, String cP, int clueV, int clueH){
        this(word, c, x, y, size);
        rowPrompt = rP;
        colPrompt = cP;
        clueNumV = clueV;
        clueNumH = clueH;
    ...
    public CrosswordTile clone(){
        CrosswordTile dolly = new CrosswordTile(word, color, x, y, size, rowPrompt, colPrompt, clueNumV, clueNumH);
        return dolly;
    }
